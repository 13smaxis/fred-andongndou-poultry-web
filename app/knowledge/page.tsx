    ...
    <>
      <div className="bg-green-800 py-12 md:py-16">
        <div className="mx-auto max-w-7xl px-4 text-center">
          <BookOpen className="mx-auto mb-4 h-12 w-12 text-green-300" />
          <h1 className="mb-3 text-3xl font-bold text-white md:text-4xl">Poultry Care Guides</h1>
          <p className="mx-auto max-w-xl text-green-200">
            Expert knowledge to help you raise healthy, productive poultry. From beginner basics to advanced management techniques.
          </p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-4xl px-4 py-8">
                  ...
                  <div className="space-y-2">
                    {guide.content.split("\n").map((line, idx) => {
                      if (line.startsWith("**") && line.endsWith("**")) {
                        return (
                          <h4 key={idx} className="mt-4 mb-2 font-bold text-gray-900">
                            {line.replace(/\*\*/g, "")}
                          </h4>
                        );
                      }
                      if (line.startsWith("- ")) {
                        return (
                          <p key={idx} className="ml-4 mb-1 text-gray-700">
        ...
        {filteredGuides.length === 0 && (
          <div className="py-12 text-center">
            <p className="text-lg text-gray-500">No guides found matching your search.</p>
          </div>
        )}
      </div>
    </>
